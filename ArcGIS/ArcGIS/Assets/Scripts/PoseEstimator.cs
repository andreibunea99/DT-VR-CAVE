...
public class PoseEstimator : MonoBehaviour
{
    ...
    [Tooltip("Use webcam as feed input")]
    ...
    // The dimmensions of the current video source
    ...
    private Utils.Keypoint[] mainPose;
    ...
    private void InitializeVideoScreen(int width, int height, bool mirrorScreen)
    {
        ...
        // Use new videoTexture for VideoPlayer
    ...
    {
        // Get a reference to the Pose Camera GameObject
        ...
        poseCamera.GetComponent<Camera>().orthographicSize = videoDims.y / 2;
    }
    ...
    void Start()
    {
        ...
        Debug.Log("Video Dims: " + videoDims);
    ...
    void Update()
    {
        ...
        // Assuming you have a reference to your VideoScreen GameObject
        GameObject videoScreen = GameObject.Find("VideoScreen");
        Vector3 videoScreenPosition = videoScreen.transform.position;
        ...
        if (user != null && skeletons.Length > 0 && skeletons[0] != null)
        {
            user.setSkeleton(skeletons[0], videoScreenOffset);
        }
    }
    ...
    public Utils.Keypoint[] GetMainPose()
    {
        return mainPose;
    }
