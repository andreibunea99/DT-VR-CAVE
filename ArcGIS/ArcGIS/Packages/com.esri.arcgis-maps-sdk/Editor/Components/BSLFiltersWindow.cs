...
namespace Esri.ArcGISMapsSDK.Editor.Components
{
	internal class BSLFiltersWindow : EditorWindow
	{
		...
		public void CreateGUI()
		{
			...
			SetPlaceholderText(valueSearchTextField, searchPlaceHolderText);
		...
		private string GetTextFieldValue(TextField textField)
		{
			...
			return textField.ClassListContains(placeholderClass) ? "" : valueSearchTextField.value;
		}
		...
		private void UpdateData()
		{
			...
			if (filterDefinition != null)
			{
				...
				if (selectedAttribute != null)
				{
					...
					{
						var searchTextFieldValue = GetTextFieldValue(valueSearchTextField).ToLowerInvariant();
