...
namespace Esri.GameEngine.Geometry
{
    ...
    public partial class ArcGISTransformationCatalog
    {
        ...
        /// <param name="outputSpatialReference">The spatial reference to use as the output.</param>
        /// <returns>
        /// An <see cref="Unity.ArcGISImmutableArray<T>">ArcGISImmutableArray<T></see> containing <see cref="GameEngine.Geometry.ArcGISDatumTransformation">ArcGISDatumTransformation</see> objects, each suitable for transforming between the given
