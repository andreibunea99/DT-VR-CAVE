...
namespace Esri.GameEngine.Layers
{
        ...
        GameEngine.Layers.Base.ArcGISLayer
    {
        ...
        #region Properties
        /// <summary>
        /// A <see cref="GameEngine.Layers.BuildingScene.ArcGISBuildingAttributeFilter">ArcGISBuildingAttributeFilter</see> from <see cref="GameEngine.Layers.ArcGISBuildingSceneLayer.BuildingAttributeFilters">ArcGISBuildingSceneLayer.BuildingAttributeFilters</see> to apply.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <remarks>
        /// To enable a building attribute filter on a layer, specify a <see cref="GameEngine.Layers.ArcGISBuildingSceneLayer.ActiveBuildingAttributeFilter">ArcGISBuildingSceneLayer.ActiveBuildingAttributeFilter</see>
        ...
        /// stored as a <see cref="Unity.ArcGISDictionary<Key, Value>">ArcGISDictionary<Key, Value></see> of key-value pairs, with each key being the attribute's name, and the associated value
        /// being a group of relevant statistics.
        /// </summary>
        /// <returns>
        /// A <see cref="Unity.ArcGISFuture<T>">ArcGISFuture<T></see> that returns a <see cref="Unity.ArcGISDictionary<Key, Value>">ArcGISDictionary<Key, Value></see> of <see cref="GameEngine.Layers.BuildingScene.ArcGISBuildingSceneLayerAttributeStatistics">ArcGISBuildingSceneLayerAttributeStatistics</see> for the <see cref="GameEngine.Layers.ArcGISBuildingSceneLayer">ArcGISBuildingSceneLayer</see>
        /// </returns>
