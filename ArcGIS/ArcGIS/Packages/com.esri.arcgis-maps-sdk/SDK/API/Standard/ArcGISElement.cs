...
namespace Esri.Standard
{
    ...
    internal partial class ArcGISElement
    {
        ...
        /// <param name="value">The value.</param>
        /// <returns>
        /// A <see cref="GameEngine.Security.ArcGISAuthenticationConfiguration">ArcGISAuthenticationConfiguration</see>.
        /// </returns>
        internal static ArcGISElement FromGEAuthenticationConfiguration(GameEngine.Security.ArcGISAuthenticationConfiguration value)
        {
            var errorHandler = Unity.ArcGISErrorManager.CreateHandler();
        ...
        /// A <see cref="GameEngine.Security.ArcGISAuthenticationConfiguration">ArcGISAuthenticationConfiguration</see>.
        /// </returns>
        internal GameEngine.Security.ArcGISAuthenticationConfiguration GetValueAsGEAuthenticationConfiguration()
        {
            var errorHandler = Unity.ArcGISErrorManager.CreateHandler();
            
            var localResult = PInvoke.RT_Element_getValueAsGEAuthenticationConfiguration(Handle, errorHandler);
            
            Unity.ArcGISErrorManager.CheckError(errorHandler);
            
            GameEngine.Security.ArcGISAuthenticationConfiguration localLocalResult = null;
            
            if (localResult != IntPtr.Zero)
            {
                var objectType = GameEngine.Security.PInvoke.RT_GEAuthenticationConfiguration_getObjectType(localResult, IntPtr.Zero);
                
                switch (objectType)
                {
                    case GameEngine.Security.ArcGISAuthenticationConfigurationType.ArcGISOAuthAuthenticationConfiguration:
                        localLocalResult = new GameEngine.Security.ArcGISOAuthAuthenticationConfiguration(localResult);
                        break;
                    default:
                        localLocalResult = new GameEngine.Security.ArcGISAuthenticationConfiguration(localResult);
                        break;
                }
            }
        ...
        /// </summary>
        /// <param name="value">The value.</param>
        internal void SetValueFromGEAuthenticationConfiguration(GameEngine.Security.ArcGISAuthenticationConfiguration value)
        {
            var errorHandler = Unity.ArcGISErrorManager.CreateHandler();
            
            var localValue = value.Handle;
            
            PInvoke.RT_Element_setValueFromGEAuthenticationConfiguration(Handle, localValue, errorHandler);
    ...
    internal static partial class PInvoke
    {
        ...
        [DllImport(Unity.Interop.Dll)]
        internal static extern IntPtr RT_Element_fromGEAuthenticationConfiguration(IntPtr value, IntPtr errorHandler);
        ...
        [DllImport(Unity.Interop.Dll)]
        internal static extern IntPtr RT_Element_getValueAsGEAuthenticationConfiguration(IntPtr handle, IntPtr errorHandler);
        ...
        [DllImport(Unity.Interop.Dll)]
        internal static extern void RT_Element_setValueFromGEAuthenticationConfiguration(IntPtr handle, IntPtr value, IntPtr errorHandler);
