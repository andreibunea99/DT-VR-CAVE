...
{
    /// <summary>
    /// A callback invoked when an <see cref="Unity.ArcGISFuture<T>">ArcGISFuture<T></see> has completed.
    /// </summary>
    /// <seealso cref="Unity.ArcGISFuture<T>.TaskCompleted">ArcGISFuture<T>.TaskCompleted</seealso>
    /// <since>1.0.0</since>
