...
namespace Esri.GameEngine.Geometry
{
    ...
    public partial class ArcGISGeometryEngine
    {
        ...
        /// <param name="distances">The distance to buffer each geometry, expressed as a <see cref="Unity.ArcGISMutableArray<T>">ArcGISMutableArray<T></see> of double. If the size of the distances collection is less than the number of geometries, the last distance value is used for the rest of geometries.</param>
        ...
        /// </remarks>
        /// <param name="geometries">A collection of geometries.</param>
        /// <param name="distances">The distance to buffer each geometry, expressed as a <see cref="Unity.ArcGISMutableArray<T>">ArcGISMutableArray<T></see> of double. If the size of the distances array is less than the number of geometries, the last distance value is used for the rest of geometries.</param>
        /// <param name="distanceUnit">The unit of measure for the distance.</param>
        /// <param name="maxDeviation">The maximum deviation between points. If NaN, then a maximum deviation of up to 0.2% of the buffer distance (maximum 0.01 meters). The purpose is to return an output geometry with a smooth boundary.</param>
        /// <param name="curveType">The <see cref="GameEngine.Geometry.ArcGISGeodeticCurveType">ArcGISGeodeticCurveType</see> used to calculate the buffer.</param>
        ...
        /// </remarks>
        /// <param name="pointCollection">A <see cref="Unity.ArcGISMutableArray<T>">ArcGISMutableArray<T></see> of <see cref="GameEngine.Geometry.ArcGISPoint">ArcGISPoint</see> geometries. Contents of the <see cref="Unity.ArcGISMutableArray<T>">ArcGISMutableArray<T></see> are copied.</param>
        ...
        /// <param name="maxDeviation">The maximum distance that the geodetic geometry can deviate from the original, in the units of the deviationUnit parameter.</param>
