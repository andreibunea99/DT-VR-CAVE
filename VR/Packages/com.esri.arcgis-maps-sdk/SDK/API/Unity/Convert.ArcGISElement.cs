...
namespace Esri.Unity
{
	internal static partial class Convert
	{
		internal static object FromArcGISElement(Standard.ArcGISElement element)
		{
			...
			switch (type)
			{
				...
				case Standard.ArcGISElementType.GEAttribute:
					...
					break;
				case Standard.ArcGISElementType.GEAuthenticationConfiguration:
					result = element.GetValueAsGEAuthenticationConfiguration();
					break;
		...
		internal static Standard.ArcGISElement ToArcGISElement<T>(T value)
		{
			...
			switch (value)
			{
				...
				case GameEngine.Security.ArcGISAuthenticationConfiguration converted:
					result = Standard.ArcGISElement.FromGEAuthenticationConfiguration(converted);
					break;
		...
		internal static Standard.ArcGISElementType ToArcGISElementType<T>()
		{
			...
			else if (typeof(T) == typeof(GameEngine.Security.ArcGISAuthenticationConfiguration))
			{
