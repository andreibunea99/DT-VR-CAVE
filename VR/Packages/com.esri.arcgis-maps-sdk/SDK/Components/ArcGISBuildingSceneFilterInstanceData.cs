...
namespace Esri.ArcGISMapsSDK.Components
{
	...
	public class ArcGISBuildingSceneLayerFilterInstanceData : ICloneable
	{
		...
		public object Clone()
		{
			...
			buildingSceneLayerFilterInstanceData.ActiveBuildingAttributeFilterIndex = ActiveBuildingAttributeFilterIndex;
			buildingSceneLayerFilterInstanceData.BuildingAttributeFilters = BuildingAttributeFilters.Clone();
			buildingSceneLayerFilterInstanceData.IsBuildingAttributeFilterEnabled = IsBuildingAttributeFilterEnabled;
			buildingSceneLayerFilterInstanceData.IsBuildingDisciplinesCategoriesFilterEnabled = IsBuildingDisciplinesCategoriesFilterEnabled;
			buildingSceneLayerFilterInstanceData.EnabledCategories = EnabledCategories.Clone();
			buildingSceneLayerFilterInstanceData.EnabledDisciplines = EnabledDisciplines.Clone();
	...
	public class ArcGISBuildingAttributeFilterInstanceData : ICloneable
	{
		...
		public object Clone()
		{
			...
			buildingAttributeFilterInstanceData.Description = Description;
			buildingAttributeFilterInstanceData.FilterID = FilterID;
			buildingAttributeFilterInstanceData.Name = Name;
			buildingAttributeFilterInstanceData.SolidFilterDefinition = SolidFilterDefinition != null ? (ArcGISSolidBuildingFilterDefinitionInstanceData)SolidFilterDefinition.Clone() : null;
	...
	public class ArcGISBuildingSceneLayerAttributeStatisticsInstanceData : ICloneable
	{
		...
		public object Clone()
		{
			...
			buildingSceneLayerAttributeStatisticsInstanceData.FieldName = FieldName;
			buildingSceneLayerAttributeStatisticsInstanceData.MostFrequentValues = MostFrequentValues.Clone();
	...
	public class ArcGISSolidBuildingFilterDefinitionInstanceData : ICloneable
	{
		...
		public virtual object Clone()
		{
			...
			solidBuildingFilterDefinitionInstanceData.Title = Title;
			solidBuildingFilterDefinitionInstanceData.WhereClause = WhereClause;
			solidBuildingFilterDefinitionInstanceData.EnabledStatistics = EnabledStatistics != null ? EnabledStatistics.Clone() : null;
	...
	public class ArcGISBuildingSceneLayerSublayerInstanceData : ICloneable
	{
		...
		public object Clone()
		{
			...
			buildingSceneLayerSublayerInstanceData.Name = Name;
			buildingSceneLayerSublayerInstanceData.ID = ID;
			buildingSceneLayerSublayerInstanceData.Discipline = Discipline;
